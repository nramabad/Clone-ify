...
pS2 = PlaylistSong.create(playlist_id: playlist3.id,song_id: song2a5.id)
pS2 = PlaylistSong.create(playlist_id: playlist1.id,song_id: song2a2.id)
...
pS6 = PlaylistSong.create(playlist_id: playlist2.id,song_id: song2a11.id)
pS7 = PlaylistSong.create(playlist_id: playlist1.id,song_id: song2a11.id)
pS8 = PlaylistSong.create(playlist_id: playlist3.id,song_id: song2a11.id)
